...
class OrderFilterTypeSheet extends StatelessWidget {
  final OrderPortalType type;

  const OrderFilterTypeSheet({super.key, required this.type});
  ...
  Widget build(BuildContext context) {
    return Consumer<OrderViewModel>(
      builder: (context, vm, child) {
        ...
        final options = vm.typeOptions;
        final selectedIndex = stateManager.selectedType == null
            ? 0
            : options.indexOf(stateManager.selectedType!);
        return Padding(
